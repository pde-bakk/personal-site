(function (e) {
  function t(t) {
    for (
      var r, a, u = t[0], i = t[1], l = t[2], s = 0, b = [];
      s < u.length;
      s++
    )
      (a = u[s]),
  ...
  var l = (window["webpackJsonp"] = window["webpackJsonp"] || []),
    s = l.push.bind(l);
  (l.push = t), (l = l.slice());
  for (var b = 0; b < l.length; b++) t(l[b]);
  var f = s;
  ...
  cd49: function (e, t, n) {
    ...
    function c(e, t, n, a, c, u) {
      var i = Object(r["A"])("particles"),
        l = Object(r["A"])("app-navigation"),
    ...
    var u = { class: "" },
      i = { class: "max-w-1xl mx-auto" },
      l = { class: "flex justify-between text-2xl" },
      s = { class: "flex space-x-6 items-center" },
      b = Object(r["i"])("Home"),
      f = Object(r["i"])("About"),
      d = Object(r["i"])("Resume"),
      p = Object(r["h"])(
              ...
              Object(r["g"])("div", s, [
                Object(r["j"])(
                  m,
                  {
                    to: { name: "Home" },
                    class:
                      "py-4 px-2 text-black-500 font-bold text-left border-b-4 border-transparent text-gray-100",
                  },
                  {
                    default: Object(r["G"])(function () {
                      return [b];
                ...
                Object(r["j"])(
                  m,
                  {
                    to: { name: "About" },
                    class:
                      "py-4 px-2 text-black-500 font-bold border-b-4 border-transparent text-gray-200",
                  },
                  {
                    default: Object(r["G"])(function () {
                      return [f];
                ...
                Object(r["j"])(
                  m,
                  {
                    to: { name: "Resume" },
                    class:
                      "py-4 px-2 text-black-500 font-bold border-b-4 border-transparent text-gray-300",
                  },
                  {
                    default: Object(r["G"])(function () {
                      return [d];
    ...
    var v = h,
      j = {
        ...
        particles: {
          ...
          opacity: { value: 0.8, random: { enable: !0, minimumValue: 0.4 } },
        },
      },
      O = Object(r["k"])({
    ...
    O.render = c;
    var g = O,
      y = (n("d3b7"), n("3ca3"), n("ddb0"), n("6c02")),
      k = function () {
        return n.e("chunk-2d21a3d2").then(n.bind(null, "bb51"));
      },
      x = function () {
        return n.e("chunk-3fa9c480").then(n.bind(null, "f820"));
      },
      w = function () {
        return n.e("about").then(n.bind(null, "1ba2"));
      },
      A = [
